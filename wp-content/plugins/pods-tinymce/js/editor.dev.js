var switchEditors = {
    ...
    go : function(id, mode) {
        ...
        if ( 'tinymce' == mode ) {
            ...
            setUserSetting( 'editor'+'_'+id, 'tinymce' );
            this.mode[id] = 'html';

            P.className = P.className.replace(' active', '') + ' active';
            ...
            setUserSetting( 'editor'+'_'+id, 'html' );
            ta.style.color = '#000';
            this.mode[id] = 'tinymce';

            H.className = H.className.replace(' active', '') + ' active';
